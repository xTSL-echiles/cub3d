...
void	ft_texture_set(t_data *img)
{
	...
	img->text[0].img_text = mlx_xpm_file_to_image(img->text->mlx_text, img->qu->ea, &img->text[0].img_width, &img->text[0].img_height);
	...
	img->text[1].img_text = mlx_xpm_file_to_image(img->text->mlx_text, img->qu->so, &img->text[1].img_width, &img->text[1].img_height);
	...
	img->text[2].img_text = mlx_xpm_file_to_image(img->text->mlx_text, img->qu->we, &img->text[2].img_width, &img->text[2].img_height);
	...
	img->text[3].img_text = mlx_xpm_file_to_image(img->text->mlx_text, img->qu->no, &img->text[3].img_width, &img->text[3].img_height);
	...
	img->text[4].img_text = mlx_xpm_file_to_image(img->text->mlx_text, img->qu->s, &img->text[4].img_width, &img->text[4].img_height);
	img->text[4].addr = mlx_get_data_addr(img->text[4].img_text, &img->text[4].bits_per_pixel,
